                    ...
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" id="species_frm" method="POST" enctype="multipart/form-data" action="add_dealer_info.php">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 col-md-3 control-label">Service Location: (Eg=> 401301,401304)</label>
                                    <div class="col-sm-4 col-md-3">
                                        <input type="text" placeholder="Enter zip code in comma separated format" class="form-control input-sm" id="service_location" name="service_location" value="<?=isset($rows_info['service_location']) ? $rows_info['service_location'] : '';?>">
                                    </div>
                                </div>
                                <div class="form-group">
